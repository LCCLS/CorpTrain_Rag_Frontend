...
class Settings:
    ...
    # Timeouts (increased for complex preparation mode operations, especially summary generation)
    # With async optimizations, most requests should be fast, but allowing longer for safety
